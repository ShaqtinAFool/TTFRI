...
- 利用剖風儀與二維雨滴譜儀對西南氣流實驗SoWMEX/TiMREX不同降水系統的觀測研究(2009)：http://hdl.handle.net/11296/ndltd/46550376097793073252
...
### 氣象學會
- 「颱風重點研究」暨「侵台颱風之GPS Dropsonde飛機偵察觀測實驗」 [2003]：
- 「侵台颱風之GPS Dropsonde飛機偵查觀測實驗」(追風計畫)與『颱風及海洋物理及生物地球化學交互作用研究』之研究回顧 [20004]：https://dbahr.narlabs.org.tw/ATMOS/32-3/V32-N3-P275.pdf
- 投落送與 QuikSCAT 資料同話對 WRF 模擬之影響 [2008]：
- GPS 掩星與其他資料同化對台灣地區颱風和梅雨模擬之影響 [2010]：
- 追風十年回顧 – 中年 Wu & LinPo 的奇幻歷程 [2013]：

## 國外
### AMS
- The impact of dropwindsonde data from the THORPEX–Pacific Area Regional Campaign and the NOAA Hurricane Field Program on tropical cyclone forecasts in the Global Forecast System [2011]：https://doi.org/10.1175/2011MWR3634.1
- The impact of assimilating dropwindsonde data deployed at different sites on typhoon track forecasts [2013]：
- Typhoon initialization in a mesoscale model – Combination of the bogused vortex with the dropwindsonde data in DOTSTAR [2008]：
- The impact of dropwindsonde observations on typhoon track forecasts in DOTSTAR and T-PARC [2011]：
...
- Observational Occurrence of Tropical Cyclone Ducts from GPS Dropsonde Data [2013]：
...
- Concentric eyewall formation in Typhoon Sinlaku (2008) – Part II: Axisymmetric dynamical processes [2012]：
- Assimilation of Tropical Cyclone Observations: Improving the Assimilation of TCVitals, Scatterometer Winds, and Dropwindsonde Observations [2015]：
- Concentric eyewall formation in Typhoon Sinlaku (2008) – Part II: Axisymmetric dynamical processes [2012]：
- Typhoon-position-oriented sensitivity analysis. Part I: Theory and verification [2013]：
- Estimating the impact of real observation in regional numerical weather prediction using an ensemble Kalman filter [2012]：
- A Squall-Line-Like Principal Rainband in Typhoon Hagupit (2008) Observed by Airborne Doppler Radar [2014]：
- The Influence of Assimilating Dropsondes on Typhoon Track and Midlatitude Forecasts [2011]：
- Dropwindsonde Observations for Typhoon Surveillance near the TAiwan Region (DOTSTAR): An overview [2005]：
- The impact of dropwindsonde data on typhoon track forecasts in DOTSTAR [2007]：
- Intercomparison of targeted observation guidance for tropical cyclones in the North western Pacific [2009]：
- Reply toComments on "Interaction of TyphoonShanshan (2006) with the midlatitude trough from both adjointderived sensitivity steering vector and potential vorticity perspectives [2009]：
- Assimilation of tropical cyclone track and structure based on the Ensemble Kalman Filter (EnKF) [2010]：
- Targeted observations of tropical cyclone movement based on the adjoint-derived sensitivity steering vector [2007]：
- Concentric eyewall formation in Typhoon Sinlaku (2008). Part I: Assimilation of T-PARC data based on the ensemble Kalman filter (EnKF) [2012]：
- Potential vorticity diagnosis of the factors affecting the track of Typhoon Sinlaku (2008) and the impact from dropwindsonde data during T-PARC [2012]：
- Accelerating the EnKF spinup for typhoon assimilation and prediction [2012]：

# NOAA P-3
## 國外
### AMS
- Thirty Years of Tropical Cyclones Research with The NOAA P-3 Aircraft [2006]：
